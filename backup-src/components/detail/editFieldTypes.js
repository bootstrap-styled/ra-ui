...
${children.map(child => `            ${child.getRepresentation()}`).join('\n')}
  ...
  array: {
    ...
    representation: (props, children) => `<ArrayInput source="${
      props.source
  ...
  reference: {
    ...
    representation: (props, children) => `<ReferenceInput source="${props.source}" reference="${
      props.reference
  ...
  referenceArray: {
    ...
    representation: props => `<ReferenceArrayInput source="${props.source}" reference="${
      props.reference
