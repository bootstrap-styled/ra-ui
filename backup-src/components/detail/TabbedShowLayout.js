import React, {
  Component, Children, cloneElement, isValidElement,
} from 'react';
 ...
 *     export default App;
 */
export class TabbedShowLayout extends Component { // eslint-disable-line react/prefer-stateless-function
  render() {
    const {
      basePath,
      children,
    ...
    return (
      ...
      >
        ...
        <CardContentInner>
          {Children.map(
            children,
            (tab, index) => tab && isValidElement(tab) ? (
              <Route
                exact
