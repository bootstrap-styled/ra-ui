...
export class FileInput extends Component {
  ...
  onDrop = files => {
    const updatedFiles = this.props.multiple
      ? [...this.state.files, ...files.map(this.transformFile)] // eslint-disable-line react/no-access-state-in-setstate
  ...
  onRemove = file => () => {
    const filteredFiles = this.state.files.filter( // eslint-disable-line react/no-access-state-in-setstate
